...
<body>
    ...
    <div class="aa">
        ...
        <hr>
        <h4 style="margin-top: -5px; text-align: center;">Laporan Data Pembayaran Transfer Pastel Futsal Arena</h4>
        ...
        <table id="example" class="table table-striped table-bordered display responsive nowrap" style="width:100%;" border="1">
            ...
            <tbody>
                <?php
                $sql = mysqli_query($conn, "SELECT * FROM transaksi WHERE MONTH(tgl_main) = MONTH(CURDATE())");
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $data['id_lapangan']; ?></t>
