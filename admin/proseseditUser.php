...
if (isset($_POST["simpan"])) {
    ...
    if ($simpann == 'insert') {
        ...
        $sql = mysqli_query($conn, "UPDATE tbl_user SET nama_usr='$nama_usr',email='$email',tempat_lahir='$tempat_lahir',alamat='$alamat',no_tlp='$no_tlp',passwordd='$pw' WHERE username = '$username'");
