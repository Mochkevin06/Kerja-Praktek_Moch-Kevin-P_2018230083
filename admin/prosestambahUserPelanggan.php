...
if (isset($_POST["simpan"])) {
    ...
    if (mysqli_num_rows($cekdata) > 0) {
        echo  "<script>window.alert('Maaf username sudah terdaftar'); document.location='index.php?url=pelanggan';</script>";
    } else {
        ...
        if ($conn->query($sql) === TRUE) {
            echo  "<script>window.alert('Registrasi anda berhasil'); document.location='index.php?url=pelanggan';</script>";
        } else {
