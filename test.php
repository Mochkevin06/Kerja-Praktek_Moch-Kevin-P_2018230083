...
<body>
                            ...
                            <div class="col-lg-6">
                                <div class="card-body">
                                    <form action="transaksi.php" method="post">
                                        ...
                                        <p class="card-text"><?php echo $data['harga_lapangan']; ?></p>
    ...
    <div class="container lapangan">
        ...
        <div class="row keten">
            <div class="col-lg-6">
                <h5><b>Syarat</b></h5>
                <p>1. Diharuskan Memiliki Email yang Aktif</p>
            </div>
            <div class="col-lg-6">
                <h5><b>ketentuan</b></h5>
                <p class="ap">1. Tidak boleh melakukan penyewaan pada tanggal dan jam yang sama.<br>
